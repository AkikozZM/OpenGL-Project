...
void MyGL::paintGL()
{
    ...
    mp_progPostprocessCurrent->setCameraPosition(m_camera.eye);
    render3DScene();
...
void MyGL::createShaders()
{
    ...
    toon->create(":/glsl/surface/toon.vert", ":/glsl/surface/toon.frag");
    m_surfaceShaders.push_back(toon);

    std::shared_ptr<SurfaceShader> hologram = std::make_shared<SurfaceShader>(this);
    hologram->create(":/glsl/surface/hologram.vert", ":/glsl/surface/hologram.frag");
    m_surfaceShaders.push_back(hologram);
