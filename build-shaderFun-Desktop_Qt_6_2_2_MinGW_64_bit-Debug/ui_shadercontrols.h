...
public:
    ...
    void retranslateUi(QWidget *ShaderControls)
    {
        ...
        surfaceShaderComboBox->setItemText(5, QCoreApplication::translate("ShaderControls", "Toon", nullptr));
        surfaceShaderComboBox->setItemText(6, QCoreApplication::translate("ShaderControls", "Hologram", nullptr));
